...
databricks-dashboard-colors, dlt-pipeline, ai-chatbot) live in skills/ and are
...
<!-- Generated by build_agents.py — do not edit directly.
     ...
     This file contains ONLY always-on guardrails (platform rules, stack, error handling).
     Domain skills (UX/UI design, data access, DLT pipelines, chatbot) live in skills/ and are
